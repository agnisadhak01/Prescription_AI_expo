  ...
  return (
    <LinearGradient colors={["#6a11cb", "#2575fc"]} style={styles.gradient}>
      <View style={styles.container}>
        ...
        <Button mode="contained" style={styles.demoButton} onPress={handleDemoLogin} contentStyle={styles.buttonContent}>
          Demo Login
        </Button>
        <Button mode="text" style={styles.button} onPress={() => {}} disabled={loading}>
          Test Connection
        </Button>
        <Button mode="text" onPress={() => router.push('/screens/RegisterScreen')} style={styles.link}>
          Register
        </Button>
